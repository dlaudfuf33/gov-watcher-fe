    ...
    <Card className="border-gray-200">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg flex items-center">
          <FileText className="h-5 w-5 mr-2 text-blue-500" />🧾 법안 활동
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-xl font-bold text-blue-600">{billActivities.total}건</p>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-500 mb-1">대표발의</p>
            <p className="text-xl font-bold text-green-600">{billActivities.representative}건</p>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-500 mb-1">공동발의</p>
            <p className="text-xl font-bold text-purple-600">{billActivities.joint}건</p>
          </div>
        </div>

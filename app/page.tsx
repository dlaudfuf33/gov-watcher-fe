...
export default function Home() {
  const currentSession = 21; // or dynamically fetched if available
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-grow">
        {/* 히어로 섹션 */}
        <div className="bg-gradient-to-r from-blue-200 via-white/90 to-red-200 py-8 backdrop-blur-sm">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="bg-gradient-to-r from-blue-500 to-red-500 text-transparent bg-clip-text">
        ...
        {/* 통계 카드 섹션 */}
        <div className="py-8 bg-white/40 backdrop-blur-sm shadow-inner ring-1 ring-inset ring-gray-300/30">
          <div className="container mx-auto px-4">
